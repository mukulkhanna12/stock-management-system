...
<body>
  <div class="container-scroller cust">
    ...
    <div class="col-md-3 styleBox">
             <form method="POST" action="shirt-insert.php"> 
          <div class ="row">
            <div class="col-md-12 ">
              <?php 
              if($row["stock"]==0)
            ...
            <div class="col-md-offset-1 col-md-11">
              <?php echo "<img  src='../images/shirt/".$row["imagepath"]."'>"; 
              ?>
            </div>
               ...
               <?php 
                 if($row["stock"]!=0)
                {
                  if (in_array($row['id'], $a)) 
                  {
                    ...
                    echo "<input type='number'  id='myNumber'style='width:100px;' name='num' class='text-center' value='1' min='1'disabled >"; 
                    echo '</div>';
                  ...
                  {
                     echo '<div class="col-md-3 mTop col-xs-4">';
                    echo "<input type='number' id='myNumber' style='width:100px;' name='num' value='1' min='1' class='text-center' >"; 
                    echo '</div>';
