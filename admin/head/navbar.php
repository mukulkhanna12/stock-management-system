      ...
      <ul class="navbar-nav navbar-nav-right">
         ...
         <li class="nav-item d-none d-lg-block">
            <a class="nav-link" href="logout.php">
              <?php echo 
              "<img class='img-xs rounded-circle' src='../images/admin/".$_SESSION["pPic"]."'>"; ?>
            </a>
         </li>
      </ul>
...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
   <ul class="nav">
      <li class="nav-item nav-profile">
         <div class="nav-link">
            <div class="profile-image"> 
             <?php echo "<img class='img-xs rounded-circle' src='../images/admin/".$_SESSION['pPic']."'>"; ?>
     ...
     <li class="nav-item">
      ...
      <li class="nav-item"><a class="nav-link" href="order-details.php"><img class="menu-icon" src="../images/menu_icons/05.png" alt="menu icon"><span class="menu-title">Order Details</span></a></li>
   
      <li class="nav-item"><a class="nav-link" href="newProduct.php"><img class="menu-icon" src="../images/menu_icons/04.png" alt="menu icon"><span class="menu-title">Add Product</span></a></li>
   
     <li class="nav-item"><a class="nav-link" href="update.php"><img class="menu-icon" src="../images/menu_icons/02.png" alt="menu icon"><span class="menu-title">Update</span></a></li>
